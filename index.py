    ...
    if media_file is not None:
        summary_response = openai.ChatCompletion.create(
            ...
            messages = [
                ...
                {"role": "user", "content": "幫我把會議紀錄根據內容整理成段落，再根據段落整理成兩個表格。第一個表格為會議摘要，內容須顯示段落主題、約50字摘要，並在表個最後一列顯示最終結論；第二個表格為待辦清單，顯示待辦事項、執行者，若沒有則填寫無"},
                {"role": "assistant", "content": "當然可以幫您進行這項任務。請提供會議紀錄的內容，我將根據您的要求整理成表格。請提供會議紀錄的文本或內容，我將嘗試協助您處理。"},
                {"role": "user", "content": "把以下會議記錄按照上面的要求彙整，並且只輸出表格，不需要其他額外的說明或是文字 :"+ tr_response}
            ]
        )
